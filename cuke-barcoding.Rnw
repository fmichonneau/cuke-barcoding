...
<<geography-diversification, cache=TRUE, echo=FALSE, fig.width=6, fig.scap='Geography of diversification', fig.cap='Number of geographic types for ESU pairs identified by the clustering method with a 3\\% threshold'>>=
...
of sister ESUs. Most had allopatric distributions (\Sexpr{formatC(percentAllo,
  digits=2)}\%), the other sister ESUs were (\Sexpr{formatC(percentSymp,
  digits=2)}\%) sympatric, and none were parapatric.
