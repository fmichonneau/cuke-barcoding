...
differentiation expected across the range as evidence by the common slope for
the orders. However, the Dendrochirotida with their lecithotrophic larvae, have
...
now sympatric), or a sampling artifact (the real sister species has not been
sampled).
