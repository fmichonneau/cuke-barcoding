...
For the tropical species, the means of the maximum range sizes for the Apodida
(\Sexpr{round(meanRange["Apodida"],2)}, SD= \Sexpr{round(sdRange["Apodida"],
  2)}) and the Aspidochirotida (\Sexpr{round(meanRange["Aspidochirotida"], 2)},
SD=\Sexpr{round(sdRange["Aspidochirotida"], 2)}) were larger than for the
Dendrochirotida (\Sexpr{round(meanRange["Dendrochirotida"], 2)},
