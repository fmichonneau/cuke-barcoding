...
the most prevalent mode in marine organisms (e.g., \cite{Meyer2005-evolution,
  Malay2010}). Compared to other marine organisms, we however recovered a higher
...
now sympatric), or a sampling artifact (the actual sister species has not been
sampled).
...
levels of genetic differentiation, but some species remain panmictic across the
Indo-Pacific. The type of larva does not seem to affect the amount of genetic
differentiation expected across the range as evidenced by the common slope and
intercept estimated across orders. However, the Dendrochirotida with their
lecithotrophic larvae, have smaller range sizes than the orders with
...
the Indian or the Pacific oceans. These results suggest that the modes of
diversification differ depending on the type of larvae. In particular, it
appears that the Dendrochirotida are more likely to diversify through founder
effect as most species cannot disperse over long distances to maintain gene flow
between distant populations. On the other hand, planktotrophic larvae can
potentially connect distant populations, and barriers to dispersal must be
required more often to lead to genetic isolation, and reproductive isolation. If
currently, few barriers to gene flow occur across the Indo-Pacific,
