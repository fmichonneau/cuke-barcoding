...
now sympatric), or an artifact of the method used (the threshold approach lumped
species, masking their original modes of speciation.


species being sympatric:
- second rapid sympatry; other hypotheses e.g. Stichopus
- masking recent diversifications in it that are allopatric
- differences in rates of evolution Euapta
- double check pardalis
-
