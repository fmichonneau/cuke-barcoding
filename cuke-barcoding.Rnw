...
(3) a polymorphic species \cite{Funk2003, Ballard2004}. These three processes
will lead to similar patterns in mitochondrial genealogies with species
appearing para- or polyphyletic. If these cases might have undesirable effects
on the accuracy of species identification, they might provide insights into the
biology of the species. For instance, sympatric paraphyletic species might be
indicative of the rapid acquisition of reproductive isolation, while
polyphyletic species might provide indication of hybridization. Through
comprehensive sampling, we can identify species that show this pattern and
deserve further investigation, and assess how common they are.

In sea cucumbers, as with other marine invertebrate, dispersal typically occurs
during the larval stage. If dispersal is spatially restricted, a pattern of
...
(see Chapter~2) recently diverged species do occur in sympatry. How common is
this pattern?
