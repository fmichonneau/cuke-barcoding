...
<<groups-comparison-plot, dependson=c('pairwise-groups-data', 'cluster-groups-data'), cache=TRUE, echo=FALSE, fig.height=6.5>>=
...
<<geography-diversification, cache=TRUE, echo=FALSE, fig.height=3, fig.scap='Geography of diversification', fig.cap='Number of geographic types for ESU pairs identified by the clustering method with a 3\\% threshold'>>=
